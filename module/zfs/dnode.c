...
dnode_cons(void *arg, void *unused, int kmflag)
{
	...
	memset(&dn->dn_next_type[0], 0, sizeof (dn->dn_next_type));
	memset(&dn->dn_next_nblkptr[0], 0, sizeof (dn->dn_next_nblkptr));
	memset(&dn->dn_next_nlevels[0], 0, sizeof (dn->dn_next_nlevels));
	memset(&dn->dn_next_indblkshift[0], 0,
	    sizeof (dn->dn_next_indblkshift));
	memset(&dn->dn_next_bonustype[0], 0, sizeof (dn->dn_next_bonustype));
	memset(&dn->dn_rm_spillblk[0], 0, sizeof (dn->dn_rm_spillblk));
	memset(&dn->dn_next_bonuslen[0], 0, sizeof (dn->dn_next_bonuslen));
	memset(&dn->dn_next_blksz[0], 0, sizeof (dn->dn_next_blksz));
	memset(&dn->dn_next_maxblkid[0], 0, sizeof (dn->dn_next_maxblkid));
...
dnode_move_impl(dnode_t *odn, dnode_t *ndn)
{
	...
	memcpy(&ndn->dn_next_type[0], &odn->dn_next_type[0],
	    sizeof (odn->dn_next_type));
	memcpy(&ndn->dn_next_nblkptr[0], &odn->dn_next_nblkptr[0],
	    sizeof (odn->dn_next_nblkptr));
	memcpy(&ndn->dn_next_nlevels[0], &odn->dn_next_nlevels[0],
	    sizeof (odn->dn_next_nlevels));
	memcpy(&ndn->dn_next_indblkshift[0], &odn->dn_next_indblkshift[0],
	    sizeof (odn->dn_next_indblkshift));
	memcpy(&ndn->dn_next_bonustype[0], &odn->dn_next_bonustype[0],
	    sizeof (odn->dn_next_bonustype));
	memcpy(&ndn->dn_rm_spillblk[0], &odn->dn_rm_spillblk[0],
	    sizeof (odn->dn_rm_spillblk));
	memcpy(&ndn->dn_next_bonuslen[0], &odn->dn_next_bonuslen[0],
	    sizeof (odn->dn_next_bonuslen));
	memcpy(&ndn->dn_next_blksz[0], &odn->dn_next_blksz[0],
	    sizeof (odn->dn_next_blksz));
	memcpy(&ndn->dn_next_maxblkid[0], &odn->dn_next_maxblkid[0],
	    sizeof (odn->dn_next_maxblkid));
	for (int i = 0; i < TXG_SIZE; i++) {
		list_move_tail(&ndn->dn_dirty_records[i],
		    &odn->dn_dirty_records[i]);
	}
	memcpy(&ndn->dn_free_ranges[0], &odn->dn_free_ranges[0],
