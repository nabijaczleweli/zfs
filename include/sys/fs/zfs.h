...
typedef enum {
	ZPROP_SRC_NONE = (1 << 0),
	ZPROP_SRC_DEFAULT = (1 << 1),
	ZPROP_SRC_TEMPORARY = (1 << 2),
	ZPROP_SRC_LOCAL = (1 << 3),
	ZPROP_SRC_INHERITED = (1 << 4),
	ZPROP_SRC_RECEIVED = (1 << 5),
	ZPROP_SRC_ALL = ZPROP_SRC_NONE | ZPROP_SRC_DEFAULT | ZPROP_SRC_TEMPORARY | ZPROP_SRC_LOCAL | ZPROP_SRC_INHERITED | ZPROP_SRC_RECEIVED,
} zprop_source_t;
